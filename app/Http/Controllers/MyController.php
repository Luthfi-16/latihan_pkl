...
class MyController extends Controller
{
    ...
    private $data = [
        ...
        ['id' => 2, 'judul' => 'Bacaan Shalat & Dzikir', 'harga' => 25000, 'kategori' => 'Bacaan'],
    ...
    public function store(Request $request)
    {
        ...
        // untuk membuat id baru secara increment
    ...
    public function show($id)
    {
        ...
        // jika buku tidak ditemukan maka dialihkan ke halaman 404
        if (! $buku) {
            abort(404);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        // mengembalikan data yang sudah diupdate kedalamn session
        session(['data_buku' => $buku]);
